...
use futures::prelude::*;
use gather_runtime::{self, GenesisConfig, opaque::Block, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	gather_runtime::api::dispatch,
	gather_runtime::native_version,
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = substrate_service::ServiceBuilder::new_full::<
			gather_runtime::opaque::Block, gather_runtime::RuntimeApi, crate::service::Executor
		>($config)?
			...
			.with_import_queue(|_config, client, mut select_chain, transaction_pool| {
				...
				let (grandpa_block_import, grandpa_link) =
					grandpa::block_import::<_, _, _, gather_runtime::RuntimeApi, _, _>(
			...
			.with_rpc_extensions(|client, pool, backend| -> RpcExtension {
